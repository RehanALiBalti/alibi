...
<body>
    <button style="font-size: 80px;" onclick="Convert_HTML_To_PDF();">Click to Generate PDF</button>
    <div id="container">
            ...
            <div class="body-content">
                <div class="sec-one">
                    <div class="left-side ">
                        ...
                        <p class="question"><b>Ich wünsche meinen Klassenkameraden...</b><?php echo $formdata['q9']; ?></p>
            ...
            <div class="comment-content">
                ...
                <div class="comment-sec-one">
                    ...
                    <div class="user-comment">
                        <?php $q = $this->db->select('image')->like('fullname', $formdata['vorname1'], 'both')->get('formdata')->row_array();
                        $imageurl = "";
